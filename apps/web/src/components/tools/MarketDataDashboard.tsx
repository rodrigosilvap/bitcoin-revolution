...
import { fetchMarketData, fetchBlockchainInfo, fetchPriceHistory } from '@/lib/services/bitcoin-service';
...
export function MarketDataDashboard() {
  ...
  const loadMarketData = useCallback(async () => {
    try {
      const [md, bi] = await Promise.all([fetchMarketData(), fetchBlockchainInfo()]);
      setMarketData(md);
      setBlockchainInfo(bi);
    } catch {
