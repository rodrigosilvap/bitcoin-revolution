    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        style={position === "popper" ? {
          ...
          marginTop: 'calc(-1 * var(--radix-select-trigger-height))',
        } : undefined}
        {...props}
      >
